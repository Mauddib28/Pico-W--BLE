...
_WRITE_SERVICE = (
    _WRITE_UUID,
    (_WRITE_GENERAL, _WRITE_VARIABLE)
)
...
_SERVICES = (_UART_SERVICE, _READ_SERVICE, _WRITE_SERVICE)
...
class BLESimplePeripheral:
    def __init__(self, ble, name="mpy-uart"):
        ...
        ( 
            ...
            (self._handle__write_general, self._handle__write_variable),     # WRITE
         ) = self._ble.gatts_register_services(_SERVICES)
        # Current Build:		_SERVICES = (_UART_SERVICE, _READ_SERVICE)
        # Other configuration
